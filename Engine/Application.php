...
namespace Liloi\Cyborgo;

use Rune\Application\General as GeneralApplication;
use Liloi\Cyborgo\Domains\Manager as DomainsManager;
use Liloi\Config\Pool;
use Liloi\Config\Sparkle;
use Liloi\Cyborgo\Exceptions\NotFoundException;
use Liloi\Cyborgo\API\Method;
...
class Application extends GeneralApplication
{
    ...
    {
        //MapsManager::load(MapsManager::URLToKey($_SERVER['REQUEST_URI']));
    ...
    public function api(string $name, array $parameters): array
    {
        ...
        $classMethod = 'Liloi\\Cyborgo\\API\\' . ucfirst(str_replace('.', '\\', $name)) . '\\Method';
